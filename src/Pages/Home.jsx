  ...
  <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold tracking-tight">
      <span className="relative inline-block">
        ...
        <span className="relative bg-gradient-to-r from-white via-blue-100 to-purple-200 bg-clip-text text-transparent whitespace-nowrap">
...
const TechStack = memo(({ tech }) => (
  <div className="px-5 py-1 hidden sm:block rounded-full bg-white/5 backdrop-blur-sm border border-white/10 text-sm text-gray-300 hover:bg-white/10 transition-colors">
    {tech}
  </div>
));
...
const WORDS = ['Embedded Systems Developer','IoT Solutions Architect','Hardware Designer','AI/ML Engineer'];
const TECH_STACK = [
  "C",
  "Python",
  "Raspberry Pi",
...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/vijaydasp" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/vijay-das-p-embedded-ai-developer-a42068283/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BBlWnu9%2BQTY2Pt21uflV0Ig%3D%3D" },
];
      ...
      >
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div
              className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0 px-4 md:pl-10 xl:pl-20"
              data-aos="fade-right"
              data-aos-delay="200"
            >
              <div className="space-y-2 sm:space-y-3">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Embedded Systems Software Developer with 3+ years of experience in designing, developing, and integrating embedded solutions for academic and industrial applications.
                </p>
                ...
                {/* CTA Buttons */}
                <div
                  className="flex flex-row gap-3 w-full justify-start mb-32"
                  data-aos="fade-up"
                  data-aos-delay="1400"
                >
                  <CTAButton
